...
class DocumentAnalyzer:
    ...
    def save_text(text):
        ...
        filename = f'document_{FILE_ID}.json'
...
async def get_analysis(file_id: str):
    """Endpoint to retrieve analysis data by file_id."""
    filename = f"document_{file_id}.json"
    try:
        ...
        # Handle JSON decoding errors (e.g., corrupt file)
        raise HTTPException(status_code=500, detail="Failed to decode the document data")
